...
#ifndef AI_YOLOBODY_H
#define AI_YOLOBODY_H
#pragma once
...
/******************************************************************************/
#define AI_YOLOBODY_MODEL_NAME          "yolobody"
#define AI_YOLOBODY_ORIGIN_MODEL_NAME   "yolobody0713"

/******************************************************************************/
#define AI_YOLOBODY_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_YOLOBODY_IN_NUM        (1)
#define AI_YOLOBODY_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 72, 72, 3, 1, NULL), \
}
#define AI_YOLOBODY_IN_SIZE { \
  AI_YOLOBODY_IN_1_SIZE, \
}
#define AI_YOLOBODY_IN_SIZE_BYTES { \
  AI_YOLOBODY_IN_1_SIZE_BYTES, \
}
#define AI_YOLOBODY_IN_1_HEIGHT      (72)
#define AI_YOLOBODY_IN_1_WIDTH       (72)
#define AI_YOLOBODY_IN_1_CHANNEL     (3)
#define AI_YOLOBODY_IN_1_SIZE        (72 * 72 * 3)
#define AI_YOLOBODY_IN_1_SIZE_BYTES  (AI_YOLOBODY_IN_1_SIZE * 1)

/******************************************************************************/
#define AI_YOLOBODY_OUT_NUM       (1)
#define AI_YOLOBODY_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 9, 9, 21, 1, NULL), \
}
#define AI_YOLOBODY_OUT_SIZE { \
  AI_YOLOBODY_OUT_1_SIZE, \
}
#define AI_YOLOBODY_OUT_SIZE_BYTES { \
  AI_YOLOBODY_OUT_1_SIZE_BYTES, \
}
#define AI_YOLOBODY_OUT_1_HEIGHT      (9)
#define AI_YOLOBODY_OUT_1_WIDTH       (9)
#define AI_YOLOBODY_OUT_1_CHANNEL     (21)
#define AI_YOLOBODY_OUT_1_SIZE        (9 * 9 * 21)
#define AI_YOLOBODY_OUT_1_SIZE_BYTES  (AI_YOLOBODY_OUT_1_SIZE * 1)

/******************************************************************************/
#define AI_YOLOBODY_N_NODES (17)
 ...
 * @ref ai_yolobody_create. Both the activations memory buffer 
 ...
 * using @ref ai_yolobody_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_YOLOBODY_*
 * defines into file @ref yolobody.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
