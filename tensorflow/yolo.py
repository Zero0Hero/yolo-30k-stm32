...
class YOLO(object):
    _defaults = {
        "model_path"        : 'model_data/yolo07013.h5',
    ...
    def generate(self):
        ...
        bodyoutput=self.yolo_model.output,
        #---------------------------------------------------------#
        #   在yolo_eval函数中，我们会对预测结果进行后处理
        #   后处理的内容包括，解码、非极大抑制、门限筛选等
        #---------------------------------------------------------#
        boxes, scores, classes = yolo_eval(bodyoutput, self.anchors,
    ...
    def detect_image(self, image):
        ...
        thickness = max((image.size[0] + image.size[1]) // 200, 1)
